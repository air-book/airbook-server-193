"""
Django settings for airbook_server_193 project.
...
SECRET_KEY = '#32e%+$ba(86fx4jo0!bfj@g)d@6a4$w%vdi=60rr@$^z%cqy3'
...
MEDIA_ROOT = os.path.abspath(localsetting.MEDIA_ROOT)
...
GRAPPELLI_ADMIN_TITLE = 'LIBRERIA'
